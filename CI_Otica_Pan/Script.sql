...
('2013-05-24','08:00',13,203,NULL,'Faltou'),
('2013-05-24','18:00',14,207,NULL,'Faltou'),
('2013-05-02','08:00',15,8,2,'Faltou'),
('2013-05-01','16:00',16,8,NULL,'Faltou'),
('2013-05-09','08:00',17,8,2,'Faltou'),
('2013-05-09','09:00',18,8,NULL,'Faltou'),
('2013-05-06','13:00',20,8,2,'Faltou'),
('2013-05-05','20:00',21,603,NULL,'Faltou'),
('2013-05-20','08:00',22,603,NULL,'Faltou'),
('2013-05-20','17:31',23,204,NULL,'Faltou'),
('2013-05-25','08:00',24,200,NULL,'Faltou'),
('2013-05-31','08:00',25,200,NULL,'Faltou'),
('2013-05-31','19:30',26,200,NULL,'Faltou'),
...
('2013-05-06','17:30',31,512,NULL,'Presente'),
('2013-05-07','08:00',32,8,NULL,'Presente'),
('2013-05-07','09:00',33,8,1,'Faltou'),
('2013-05-07','08:30',34,200,NULL,'Faltou'),
('2013-06-18','09:00',35,8,NULL,'Presente');
...
/*
Table data for otica_pan.cheque
*/

INSERT INTO `cheque` VALUES 
(1,'2013-06-19',125.86,5,'1º Parcela',1),
(2,'2013-07-19',125.86,5,'2º Parcela',0),
(3,'2013-08-19',125.86,5,'3º Parcela',0),
(4,'2013-06-29',103.63,6,'1º Parcela',0),
(5,'2013-07-10',103.63,6,'2º Parcela',0),
(6,'2013-08-10',103.63,6,'3º Parcela',1),
(7,'2013-06-17',3.63,7,'1º Parcela',0),
(8,'2013-07-17',3.63,7,'2º Parcela',0),
(9,'2013-08-17',3.63,7,'3º Parcela',0),
(10,'2013-06-20',200,8,'1º Parcela',0),
(11,'2013-07-20',200,8,'2º Parcela',0),
(12,'2013-08-20',200,8,'3º Parcela',1),
(13,'2013-06-11',10,9,'1º Parcela',1),
(14,'2013-07-11',10,9,'2º Parcela',0),
(15,'2013-08-11',10,9,'3º Parcela',1),
(16,'2013-06-13',150,10,'1º Parcela',1),
(17,'2013-07-11',150,10,'fesfsefs',1);
...
('564.878.431-72','1990-01-13',8,10),
...
/*
Table data for otica_pan.consulta
*/
...
/*
Table data for otica_pan.contas_pagar
*/

INSERT INTO `contas_pagar` VALUES 
(1,'Aluguel','adawjndwjandjkawdaw',30,'2013-06-04');
...
/*
Table data for otica_pan.diagnostico
*/
...
('Vila Carmela','07859-180','Guarulhos','Casa','SP',7,'Rua Majestic',8),
...
/*
Table data for otica_pan.informacoes_olho
*/

INSERT INTO `informacoes_olho` VALUES 
('Longe','OD',1),
('Longe','OE',2),
('Longe','OD',5),
('Longe','OE',6),
...
/*
Table data for otica_pan.itens
*/

INSERT INTO `itens` VALUES 
(1,'Limpador de Lente 30ml',8,30,1),
(1,'Relógio Tag Hauer',9,300,2),
(1,'Lápis de Cor 10 uni.',10,10.9,1),
(2,'Limpador de Lente 30ml',8,30,1),
(2,'Relógio Tag Hauer',9,300,2),
(2,'Lápis de Cor 10 uni.',10,10.9,1),
(3,'Limpador de Lente 30ml',8,30,1),
(3,'Relógio Tag Hauer',9,300,2),
(3,'Lápis de Cor 10 uni.',10,10.9,1),
(4,'Lápis de Cor 10 uni.',10,10.9,1),
(5,'Relógio Tag Hauer',9,300,1),
(6,'Limpador de Lente 30ml',8,30,1),
(7,'Lápis de Cor 10 uni.',10,10.9,1),
(7,'Relógio Tag Hauer',9,300,1),
(7,'Relógio Tag Hauer',9,300,1),
(8,'Relógio Tag Hauer',9,300,1),
(8,'Lápis de Cor 10 uni.',10,10.9,1),
(9,'Lápis de Cor 10 uni.',10,10.9,1),
(10,'Relógio Tag Hauer',9,300,1),
(10,'Relógio Tag Hauer',9,300,1),
(11,'Limpador de Lente 30ml',8,30,1),
(12,'Relógio Tag Hauer',9,300,1),
(13,'Paçoquinha',11,10,5),
(13,'Relógio Tag Hauer',9,300,1),
(13,'Lápis de Cor 10 uni.',10,10.9,3);
...
/*
Table data for otica_pan.lente
*/

INSERT INTO `lente` VALUES 
(2,'2009','Lente Multifocal',40),
(3,'2009','Lente Multifocal',40),
(13,'0001','Lente Multifocal',30);
...
('738543',2,'Daniela Lima de Souza',5);
...
/*
Table data for otica_pan.orcamento
*/

INSERT INTO `orcamento` VALUES 
('2013-06-08',1,'Administrador',1,0,1,NULL),
('2013-06-08',1,'Administrador',2,0,1,8),
('2013-06-08',1,'Administrador',3,100,0,8),
('2013-06-09',1,'Administrador',4,0,0,NULL),
('2013-06-09',1,'Administrador',5,0,0,204),
('2013-06-10',1,'Administrador',6,0,0,NULL),
('2013-06-10',3,'Administrador',7,233.33,0,NULL),
('2013-06-10',3,'Administrador',8,0,0,NULL),
('2013-06-10',3,'Administrador',9,0,0,NULL),
('2013-06-10',3,'Administrador',10,0,0,NULL),
('2013-06-10',3,'Administrador',11,0,0,8),
('2013-06-10',3,'Administrador',12,0,0,NULL),
('2013-06-15',1,'Administrador',13,100,0,8);
...
('pamela.oliveira@gmail.com','Pamela Lima De Oliveira',10),
...
('7891331010522','Limpador de Lente 30ml',0,NULL,8,20,30,97,1,NULL),
('3491331010936','Relógio Tag Hauer',0,NULL,9,200,300,989,1,NULL),
('3491331011350','Lápis de Cor 10 uni.',0,NULL,10,6.9,10.9,62,1,NULL),
('3491331011764','Paçoquinha',0,'Paçoca de amendoim',11,6.75,10,295,1,'2030-01-01'),
('3491331012592','Limpador de Lente 50ml',0,'',12,7.99,15,200,1,NULL),
('3491331013006','Porta Retrato',0,'',13,10,20,100,1,NULL),
('3491331013420','Óculos HB 390',0,'',14,140,219,50,1,NULL),
('3491331013834','Óculos Bad Boy',0,'',15,200,290,100,1,NULL),
('3491331014248','Óculos Real M',0,'',16,90,180,100,1,NULL),
('3491331014662','Óculos HFD',0,'',17,140,300,90,1,NULL),
('3491331015076','Óculos Try',0,'',18,200,300,100,1,NULL),
('3491331016318','Óculos Real Back',0,'',19,300,390,190,1,NULL),
('3491331016732','Óculos Mazon 289',0,'',20,300,330,100,1,NULL),
('3491331017146','Óculos 2893',0,'',21,100,50,200,1,NULL),
('3491331017560','Óculos 42893',0,'',22,150,200,200,1,NULL),
('3491331017974','Óculos 8409',0,'',23,190,250,200,1,NULL),
('3491331018388','Óculos 9383',0,'',24,100,200,100,1,NULL),
...
/*
Table data for otica_pan.receita
*/

INSERT INTO `receita` VALUES 
('112492','2013-05-06','Não é necessário medir o DP na ótica.',60,1,512,NULL,'Adriana Vanella D Agostinho'),
('738543','2013-05-07','Cliente necessita de óculos.',100,3,8,NULL,'Daniela Lima de Souza'),
('112492','2013-06-18','dawdaw\r\n',200,4,8,NULL,'Adriana Vanella D Agostinho');
...
/*
Table data for otica_pan.servico
*/

INSERT INTO `servico` VALUES 
(2,'Consulta Oftalmológica',50,'Consulta oftalm.'),
(3,'Consulta Oftalmológica',50,NULL),
(13,'Consulta Oftalmologica',40,'Consulta');
...
/*
Table data for otica_pan.venda
*/

INSERT INTO `venda` VALUES 
('2013-06-08','06:55',1,3),
('2013-06-09','23:43',2,4),
('2013-06-09','23:43',3,5),
('2013-06-10','00:15',4,6),
('2013-06-10','00:30',5,7),
('2013-06-10','00:31',6,8),
('2013-06-10','00:34',7,9),
('2013-06-10','00:35',8,10),
('2013-06-10','00:36',9,11),
('2013-06-10','00:46',10,12),
('2013-06-15','20:30',11,13);
