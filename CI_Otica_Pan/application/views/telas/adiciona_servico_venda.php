...
<fieldset>
    ...
    <table>
        <tr>
            ...
            <td>Preço:</td><td><input type="text" style="width:210px;" name="preco" value="<? echo set_value('preco'); ?>" autocomplete="off" placeholder='XXX,XX.' required title="Campo preço é obrigatório" /></td></tr><tr>
