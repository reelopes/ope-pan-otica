...
if ($this->session->userdata('parcelas') != null) {
    ...
    <body onload="
            ...
            document.getElementById('valor_1').setAttribute('required', 'true');">
              ...
              ?>
    <body onload="
            document.getElementById('valor_1').value = opener.document.getElementById('total').value;
            document.getElementById('data_1').setAttribute('required', 'true');
            document.getElementById('descricao_1').setAttribute('required', 'true');
            document.getElementById('valor_1').setAttribute('required', 'true');">
          <? }
    ...
    <fieldset>
        ...
        <div style ="float: left; " align="left">
            Número de Parcelas <select name="selectParcelas" onchange="parcelas(this);">
                <?
                for ($i = 1; $i < 4; $i++) {
...
if ($this->session->userdata('parcelas') != null) {
    ...
    for ($i = 1; $i < 4; $i++) {
        ...
        echo '<tr id="tr_' . $i . '" style=display:' . $display . '>
            <td><input type="date" min="' . date('Y-m-d') . '" id="data_' . $i . '" '.$required.' value="' . $cheques[$i - 1][data] . '" name="data_' . $i . '" style="width:150px;"></td>
