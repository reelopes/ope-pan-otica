...
echo'<select name="dependente" style=" height:25px;">';
        ...
        echo'</select>';
echo"</td><td>";
echo "<img src='".base_url("public/img/pesquisa_cliente.png")."' width='40px' title='Pesquisar Cliente' style='vertical-align: middle; cursor: hand;' OnClick=\"abrirPopUp('".base_url('receita/listarClientes')."','600','445');\">";
echo"</td></tr>";
echo"<tr><td>";
