...
<p align='right'><table border="0"  id="icone_desbotado">
    <tr>    
    <td align="right">
            <? echo "<a href='#'><img src='".base_url('public/img/impressora.png')."' title='Imprimir' width='50px' class='impressao' onClick='window.print();'></a>"; ?>
...
echo"<br>";
echo"<br>";
echo '<b>De </b>'.$this->util->data_mysql_para_user($this->session->userdata('dataInicial'));
echo '<b>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; Até </b>'.$this->util->data_mysql_para_user($this->session->userdata('dataFinal'));
echo" </p>";
echo"<br>";
echo"<br>";
echo"</div>";
...
echo"<td>Valor</td>";
echo"</tr>";
$dadosRelatorio = $this->session->userdata('dadosRelatorio');
