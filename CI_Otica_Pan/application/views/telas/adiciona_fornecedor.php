...
echo"</td><td>"; 
echo form_input(array('name'=>'nome'),  set_value('nome'),'maxlength="100" autocomplete ="off" placeholder="Nome Completo do Fornecedor" autofocus style="width:300px;" required title="Campo Nome é obrigatório" onkeypress="return SomenteLetras(event);"')."<span title='Campo obrigatório'>*</span>";
echo"</td></tr>";
echo"<tr><td>";
...
echo"</td><td>"; 
echo form_input(array('name'=>'cnpj'),  set_value('cnpj'),'maxlength="18" autocomplete ="off" placeholder="XX.XXX.XXX/XXXX-XX" OnKeyPress="MascaraCNPJ(this)" pattern="^(\d{2}\.\d{3}\.\d{3}/\d{4}-\d{2})|(\d{14})$" required title="Campo CNPJ é obrigatório e deve ser digitado no formato (00.000.000/0000-00)"')."<span title='Campo obrigatório'>*</span>";
