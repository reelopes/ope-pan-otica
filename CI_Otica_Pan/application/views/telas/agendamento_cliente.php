...
if ($id_cliente != null) {
        ...
        <table><tr>
                <td>Data <span style="color:gray;" title="Campo obrigatório">*</span></td><td><input type="date" name="data" value="<? echo $anoCalendario . '-' . $mesCalendario . '-' . $dia ?>" min="<? echo date('Y-m-d') ?>"  required /></td></tr><tr>
