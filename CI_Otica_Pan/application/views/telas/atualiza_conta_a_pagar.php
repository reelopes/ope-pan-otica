...
<fieldset>
    ...
    <table>
        <tr>
            <td>Nome <span style="color:gray;" title="Campo obrigatório">*</span></td><td><input type="text" style="width:310px;" name="nome" value="<? echo set_value('nome',$query->nome); ?>"maxlength="50" placeholder='Nome da Conta' autocomplete="off" autofocus required title="Campo nome é obrigatório" autofocus /></td></tr><tr>
            <td>Valor <span style="color:gray;" title="Campo obrigatório">*</span></td><td><input type="text" style="width:210px;" name="preco" value="<? echo set_value('preco',$valor); ?>" autocomplete="off" placeholder='XXX,XX' required title="Campo preço é obrigatório" onkeypress="return(FormataReais(this,'.',',',event));" /></td></tr><tr>
            <td>Vencimento <span style="color:gray;" title="Campo obrigatório">*</span></td><td><input type="date" style="width:155px;" name="data" value="<? echo set_value('data',$query->data); ?>" required title="Campo Vencimento é obrigatório" autocomplete="off" /></td></tr><tr>
