...
echo form_input(array('name'=>'num_telefone2'),  set_value('num_telefone2'),'maxlength="15" autocomplete ="off" placeholder="(XX) XXXX-XXXXX" OnKeyPress="MascaraTelefone(this)" onChange="MascaraTelefone(this)" pattern="\([0-9]{2}\)[\s][0-9]{4,5}-[0-9]{4}" title="Campo Telefone deve ser digitado no formato (XX) XXXXXX-XXXX"');
echo"</td></tr>";//Essa linha pode remover
echo"</table>";
