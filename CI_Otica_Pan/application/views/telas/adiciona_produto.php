...
echo"</td><td>"; 
echo form_input(array('name'=>'preco_custo'),  set_value('preco_custo'), 'maxlength="7" placeholder="0000,00" autocomplete ="off" onkeypress="return(FormataReais(this,\'.\',\'.\',event))" style="width:80px;"');
echo"</td>";
echo"<td>";
echo form_label('Preco de venda');
echo"</td><td>"; 
echo form_input(array('name'=>'preco_venda'),  set_value('preco_venda'), 'placeholder="0000,00" autocomplete ="off" onkeypress="return(FormataReais(this,\'.\',\'.\',event)); maxlength="7"" style="width:80px;"');
echo"</td></tr>";
echo"<tr><td>";
